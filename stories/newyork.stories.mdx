...
isHidden: false
media:
   src: ::file ./media/newyork_banner.webp
   alt: New York City
   author:
...
<Block>
    <Prose>
      ...
      <Figure>
        <Image
            src={new URL('./media/nyc_story_image_asset_1.webp', import.meta.url).href}
...
<Block >
  <Prose>
    ...
    <Figure>
      <Image
        src={new URL('./media/nyc_story_image_asset_3.webp', import.meta.url).href}
