export const tools = [
    {
        ...
        "img": {
          "src": new URL('../../common/media/EMIT_Plume_Viewer_card.webp', import.meta.url).href,
    ...
    },
    {
      ...
      "hideExternalLinkFlag": true,
      "img": {
        "src": new URL('../../common/media/GOES_Methane_Plume_viewer_card.webp', import.meta.url).href,
    ...
    },
    {
      ...
      "img": {
        "src": new URL('../../common/media/EPA_Gridded_Methane_card.webp', import.meta.url).href,
    ...
    },
    {
      ...
      "hideExternalLinkFlag": true,
      "img": {
        "src": new URL('../../common/media/NOAA_Methane_Concentration_Viewer_card.webp', import.meta.url).href,
    ...
    },
    {
      ...
      "img": {
        "src": new URL('../../common/media/NIST_NEC_Methane_Viewer_card1.webp', import.meta.url).href,
...
export const stories = [
    {
        ...
        "img": {
          "src": new URL('./media/EMIT_story_card.webp', import.meta.url).href,
    ...
    },
    {
        ...
        "img": {
          "src": new URL('./media/NIST_Methane_Intercomparisons_card.webp', import.meta.url).href,
    ...
    },
    {
        ...
        "img": {
          "src": new URL('./media/Wetlands_image_v2_rs.webp', import.meta.url).href,
    ...
    },
    {
        ...
        "img": {
          "src": new URL('../media/EPA_Super_Emitters_card.webp', import.meta.url).href,
    ...
    },
    {
        ...
        "img": {
          "src": new URL('./media/GOES_story_card_image.webp', import.meta.url).href,
...
export const trainings = [
    {
        ...
        "img": {
            "src": new URL('../../overrides/media/Methane_Website_Header.webp', import.meta.url).href,
...
export const datasets = [
    {
        ...
        "img": {
          "src": new URL('../../datasets/media/epa-annual--cover.webp', import.meta.url).href,
    ...
    },
    {
        ...
        "img": {
          "src": new URL('../../datasets/media/goes-ch4plume--cover.webp', import.meta.url).href,
    ...
    },
    {
        ...
        "img": {
          "src": new URL('../../datasets/media/ch4-wetland--cover.webp', import.meta.url).href,
    ...
    },
    {
        ...
        "img": {
          "src": new URL('../../datasets/media/ct-ch4-monthgrid-v2023-cover.webp', import.meta.url).href,
