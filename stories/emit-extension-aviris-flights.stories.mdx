...
media:
  src: ::file ./methane/media/EMIT_story_card.webp
...
<Block>
    <Prose>
        ...
        <Figure>
            <Image
                src={new URL('./media/EMIT_extension_story_body_image1.webp', import.meta.url).href}
...
<Block>
    <Prose>
        ...
        <Figure>
            <Image
                src={new URL('./media/EMIT_extension_story_body_image3.webp', import.meta.url).href}
...
<Block>
    <Prose>
        ...
        - Detailed dataset information: <Link to='/data-catalog/emit-ch4plume-v2'>EMIT Methane Point Source Plume Complexes</Link>
