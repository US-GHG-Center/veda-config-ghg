...
description: "NASA uses satellite instruments to monitor volcanic emissions and resulting emission impacts on global air quality."
featured: true
media:
  src: ::file ./media/volcano--discovery-cover.jpg
...
taxonomy:
  - name: Topics
    values:
      - Volcanic Emissions
      - Satellite Measurement of Air Quality
  - name: Pollutants
    values:
      - SO₂
  - name: Source
...
<Block>
  <Prose>
    ...
    <Figure>
    <Image
      src={new URL("./media/Kamoamoa_2011.jpg", import.meta.url).href}
...
<Block>
  ...
  <Figure>
    <Chart
      dataPath={new URL('./media/so2-emissions.csv', import.meta.url).href}
      dateFormat="%Y" 
      idKey='Type' 
      xKey='Year' 
      yKey='Emissions' 
...
<Block>
  <Figure>
    <Image
      src={new URL("./media/Degassing.jpg", import.meta.url).href}
...
<Block>
  ...
  <Figure>
    <Image
      src={new URL("./media/La_Palma_lava_flows_into_the_sea.jpg", import.meta.url).href}
