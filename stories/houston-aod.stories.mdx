...
media:
  src: ::file ./media/steam-power-plant.png
...
<ScrollytellingBlock>
  ...
  >
    ...
    <Chart
      dataPath={new URL('./media/baytown_adjusted.csv', import.meta.url).href}
      dateFormat="%Y-%m"
      idKey='source'
      xKey='Date'
      yKey='Mean AOD'
  ...
  >
    ...
    <Chart
      dataPath={new URL('./media/west_houston_adjusted.csv', import.meta.url).href}
      dateFormat="%Y-%m"
      idKey='source'
      xKey='Date'
      yKey='Mean AOD'
  ...
  >
    ...
    <Chart
      dataPath={new URL('./media/Houston_IAH.csv', import.meta.url).href}
      dateFormat="%Y-%m"
      idKey='source'
      xKey='Date'
      yKey='Mean AOD'
