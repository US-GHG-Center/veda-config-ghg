...
media:
  src: ::file ./media/EPA_Super_Emitters_card.webp
...
<Block>
    <Prose>
        <Figure>
            <Image
                src={new URL('./media/PIA20716~orig.webp', import.meta.url).href}
...
<Block>
    <Prose>
        ...
        <Figure>
            <Image
                src={new URL('./media/NASA_EPA_Page_2.webp', import.meta.url).href}
