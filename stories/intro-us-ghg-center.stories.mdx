...
<Block>
    <Figure>
        ...
        <Caption> This animation shows estimates of wetland methane emissions produced by the Lund–Potsdam–Jena Dynamic Global Vegetation Model (LPJ-DGVM) Wald Schnee und Landscaft version (LPJ-wsl). Animation by NASA Scientific Visualization Studio. </Caption>
    </Figure>
</Block>
