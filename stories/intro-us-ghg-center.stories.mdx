...
media:
  src: ::file ./media/intro-to-ghg-center--cover.webp
...
<Block>
    ...
    <div style={{display: "flex", "align-items": "center", "justify-content": "center"}}>
        <figure style={{display: "inline-block", width:"250px", margin:"4px 2px 2px 2px"}}>
            <img src={new URL('./media/refinery.webp', import.meta.url).href} alt='anthropogenic emissions' />
            <figcaption>Anthropogenic GHG Emissions</figcaption>
        </figure>
        <figure style={{display: "inline-block", width:"250px", margin:"2px"}}>
            <img src={new URL('./media/swamp.webp', import.meta.url).href} alt='natural sources and sinks' />
            <figcaption>Natural GHG Sources and Sinks</figcaption>
        </figure>
        <figure style={{display: "inline-block", width:"250px", margin:"2px"}}>
            <img src={new URL('./media/plume.webp', import.meta.url).href} alt='large emission events' />
