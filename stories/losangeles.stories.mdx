...
<Block>
  <Prose>
        More recently, Dustin Roten of NASA’s Jet Propulsion Laboratory in Southern California combined the OCO-3 maps with a dataset of fossil fuel carbon dioxide emissions from North [Arizona University’s Vulcan Project](https://earth.gov/ghgcenter/stories/vulcan). This allowed his team to identify emissions coming specifically from factories, ships and roadways, another step in digging greater detail out of the data.
