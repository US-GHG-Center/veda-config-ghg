...
<Block>
  <Prose>
    ...
    >
      Carbon dioxide emissions data are now available at a granular level, from
      city blocks to entire counties across the contiguous U.S. The latest
      dataset from the Vulcan Project, called Vulcan 4.0, helps researchers to
      analyze annual CO2 emissions at fine scales and helps urban
      decision-makers to develop localized carbon management strategies.
    </div>
  </Prose>
</Block>
...
<Block>
  <Prose>
    ## Carbon Dioxide Emissions Estimates Available at Neighborhood Scale
