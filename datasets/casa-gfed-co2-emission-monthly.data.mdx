...
usage:
  - url: 'https://github.com/US-GHG-Center/ghgc-docs/blob/main/cog_transformation_scripts/casagfed-carbonflux-monthgrid-v3_Transformation_Code.py'
...
<Block>
  <Prose>    
    ...
    - [Data Transformation Code](https://github.com/US-GHG-Center/ghgc-docs/blob/main/cog_transformation_scripts/casagfed-carbonflux-monthgrid-v3_Transformation_Code.py)
