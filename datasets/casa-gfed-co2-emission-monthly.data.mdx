...
usage:
  - url: 'https://github.com/US-GHG-Center/ghgc-docs/blob/main/cog_transformation_scripts/emit-ch4plume-v1_User_Notebook.ipynb'
    label: Notebook to transform netcdf to COG
    title: 'CASA-GFED3 carbon flux data transformation notebook'
  - url: 'https://github.com/US-GHG-Center/ghgc-docs/blob/main/user_data_notebooks/emit-ch4plume-v1_User_Notebook.ipynb'
