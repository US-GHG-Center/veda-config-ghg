...
<Block>
  ...
  <Figure>
    <iframe
      src="https://dev.openveda.cloud/api/raster/collections/climdex-tmaxxf-access-cm2-ssp126/items/climdex-tmaxxf-access-cm2-ssp126-2100/WebMercatorQuad/map?bidx=1&assets=tmax_above_90&nodata=nan&rescale=0%2C365&resampling=bilinear&colormap_name=ylorrd"
      width="100%"
      height="400px"
