...
infoDescription: |
  ::markdown
    ...
    - Data Units: Kilograms of Carbon per square meter per day (kg Carbon/m²/day)
    - Data Type: Research
...
layers:
  - id: micasa-co2-flux-npp
    ...
    sourceParams:
      ...
      rescale:
        ...
        - 1.5
    compare:
      datasetId: micasa-carbonflux-daygrid-v1
  ...
  - id: micasa-co2-flux-nbe
    stacCol: micasa-carbonflux-daygrid-v1
    name: Net Biosphere Exchange (NBE)
    type: raster
...
<Block>
  <Prose>
    ...
    **Data Units:**  Kilograms of Carbon per square meter per day (kg Carbon/m²/day)<br />
...
<Block>
  <Prose>
    ...
    - A unit change of kg Carbon/m²/month to kg Carbon/m²/day
    ...
    The full title of this dataset, MiCASA Daily NPP Rh Fire Fuel Fluxes 0.1 degree x 0.1 degree V1, has been shortened for display on the US GHG Center website. The short name of the source dataset is MICASA_D_FLUX, and it is referred to as micasa-carbonflux-daygrid-v1 within the Center system. The source dataset in NetCDF format is available from the NCCS DataPortal (see Source Data Product Citation above). A user guide is available at the following link. [https://portal.nccs.nasa.gov/datashare/gmao/geos_carb/MiCASA/v1/netcdf/MiCASA_README.pdf](https://portal.nccs.nasa.gov/datashare/gmao/geos_carb/MiCASA/v1/netcdf/MiCASA_README.pdf).
