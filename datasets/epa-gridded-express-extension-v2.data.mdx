...
name: Express Extension Gridded Methane Emissions v2
description: Annual 0.1 degree resolution estimates of anthropogenic methane emissions for the U.S. region for 2015-2018
usage:
...
layers:
  - id: enteric-fermentation
    stacCol: epa-ch4emission-grid-v2express
