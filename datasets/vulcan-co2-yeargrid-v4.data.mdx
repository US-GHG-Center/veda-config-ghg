...
usage:
  ...
  - url: https://data.ghg.center/browseui/index.html#vulcan-ffco2-yeargrid-v4/
    ...
    title: Data Browser
media:
  src: ::file ./media/vulcan--dataset-cover.webp
...
layers:
  - id: vulcan-total-co2
    ...
    media:
      src: ::file ./media/vulcan-co2-yeargrid-v4.thumbnails.total.webp
...
<Block type="wide">
  <Figure>
    <Embed
      height="800"
      src="https://earth.gov/ghgcenter/data-tools/view/urban-dashboard?dataset=vulcan"
    />
  </Figure>
</Block>
<Block>
