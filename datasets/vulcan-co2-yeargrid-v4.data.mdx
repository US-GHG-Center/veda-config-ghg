...
layers:
  ...
  - id: vulcan-cmv-co2
    stacCol: vulcan-ffco2-yeargrid-v4
    name: Commercial Marine Vessel Fossil Fuel CO₂ Emissionss
    type: raster
  ...
  - id: vulcan-nrd-co2
    stacCol: vulcan-ffco2-yeargrid-v4
    name: Non-Road Fossil Fuel CO₂ Emissions
    type: raster
  ...
  - id: vulcan-onr-co2
    stacCol: vulcan-ffco2-yeargrid-v4
    name: On-Road Fossil Fuel CO₂ Emissions
    type: raster
...
<Block>
  <Prose>
    ...
    **Data Units:** Units are metric tonnes of carbon per 1 km x 1 km grid cell per year (tC/km²/year)<br />
