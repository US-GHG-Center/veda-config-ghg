...
name: High Resolution Sea Surface Temperature GHRSST
...
layers:
  - id: tempo-l2
    ...
    zoomExtent:
      ...
      - 20
    sourceParams:
      concept_id:	G3278593284-GES_DISC
      backend: xarray
      bands:
        - 4/2014/OCO2GriddedXCO2_20140906_v4_1724366076
      minzoom: 0
      maxzoom: 20
