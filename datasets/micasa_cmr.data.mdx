---
id: micasa-carbonflux-grid-v1-cmr
name: TEMPO Cloud Pressure and Fraction
...
layers:
  - id: tempo-l2
    type: cmr
    stacCol: TEMPO_CLDO4_L2_V03
    stacApiEndpoint: "https://cmr.earthdata.nasa.gov/stac/LARC_CLOUD"
    tileApiEndpoint: "https://dev-titiler-cmr.delta-backend.com/WebMercatorQuad/tilejson.json"
    name: TEMPO cloud pressure and fraction
    description: Items in the collection TEMPO_CLDO4_L2_V03
    time_density: day
    zoomExtent:
      - 0
      - 20
    sourceParams:
      concept_id:	G3059360813-LARC_CLOUD
      backend: rasterio
      bands:
        - 02/TEMPO_CLDO4_L2_V03_20230802T151249Z_S001G01
      minzoom: 0
      maxzoom: 20
---
