...
layers:
  - id: blueflux-ghgflux-daygrid-ch4-v1
    ...
    name: Methane Flux
    type: raster
    description: Daily estimates of methane (CH4) flux over mangrove and marsh ecosystems.
  ...
  - id: blueflux-ghgflux-daygrid-co2-v1
    ...
    type: raster
    description: Daily estimates of carbon dioxide (CO2) flux over mangrove and marsh ecosystems.
    initialDatetime: newest
    projection:
      id: 'equirectangular'
    basemapId: 'light'
