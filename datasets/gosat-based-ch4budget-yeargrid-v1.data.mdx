...
layers:
  - id: post-total
    ...
    info:
      ...
      unit: Tg CH₄/yr
    media:
      src: ::file ./media/gosat-based-ch4budget-yeargrid-v1.thumbnails.posterior.total.webp
  ...
  - id: post-wetland
    ...
    info:
      ...
      unit: Tg CH₄/yr
    media:
      src: ::file ./media/gosat-based-ch4budget-yeargrid-v1.thumbnails.posterior.wetlands.webp
...
<Block>
  <Prose>
    ...
    **Spatial Resolution:** 4°(latitude) x 5°(longitude)<br />
...
<Block>
  <Prose>
    ...
    - Removal of uncertainty and priori data layers (priori model-estimated methane emissions for wetlands remains accessible via the [US GHG Center STAC Catalog](https://radiantearth.github.io/stac-browser/#/external/earth.gov/eic/api/stac/ghgc?.language=en))
