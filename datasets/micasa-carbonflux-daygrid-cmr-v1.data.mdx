...
layers:
  - id: micasa-co2-flux-npp-cmr
    stacCol: micasa-carbonflux-daygrid-cmr-tes
    type: cmr
    ...
    name: (Monthly-On fly) Net Primary Production (NPP)
    ...
    compare:
      ...
      layerId: micasa-carbonflux-grid-cmr-v1
      mapLabel: |
    ...
    info:
      ...
      unit: g Carbon/m²/day 
  - id: micasa-co2-flux-npp-cmr-raw
    stacCol: micasa-carbonflux-daygrid-cmr-tes
    type: cmr
    stacApiEndpoint: "https://dev.ghg.center/api/stac/" 
    tileApiEndpoint: "https://staging.openveda.cloud/api/titiler-cmr/WebMercatorQuad/tilejson.json"
    name: (No conversion - Monthly) Net Primary Production (NPP)
    description: Model-estimated net primary production (NPP), which is the rate at which plants produce and store carbon that is available to the ecosystem (biomass increase)
    time_density: Monthly
    initialDatetime: newest
    projection:
      id: 'equirectangular'
    basemapId: 'light'
    ...
    compare:
      datasetId: micasa-carbonflux-grid-cmr-v1
      layerId: micasa-co2-flux-npp-cmr-raw
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          if (dateFns && datetime && compareDatetime) return `${dateFns.format(datetime, 'LLL yyyy')} VS ${dateFns.format(compareDatetime, 'LLL yyyy')}`;
        }
  ...
  - id: micasa-co2-flux-nbe-cmr-raster
    stacCol: micasa-carbonflux-daygrid-cmr-tes
    type: cmr
    stacApiEndpoint: "https://dev.ghg.center/api/stac/" 
    tileApiEndpoint: "https://staging.openveda.cloud/api/titiler-cmr/WebMercatorQuad/tilejson.json"
    name: (Raster Calculation Test) Net Biosphere Exchange (NBE) - NEE+FIRE+FUEL
    ...
    compare:
      datasetId: micasa-carbonflux-grid-cmr-v1
      layerId: micasa-co2-flux-nbe-cmr-raster
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          if (dateFns && datetime && compareDatetime) return `${dateFns.format(datetime, 'LLL yyyy')} VS ${dateFns.format(compareDatetime, 'LLL yyyy')}`;
        }
    ...
    info:
      ...
      spatialExtent: Global
      temporalResolution: Monthly
      unit: kg Carbon/m²/day


  - id: micasa-co2-flux-nbe1-cmr-raster
    stacCol: micasa-carbonflux-daygrid-cmr-tes
    type: cmr
    stacApiEndpoint: "https://dev.ghg.center/api/stac/" 
    tileApiEndpoint: "https://staging.openveda.cloud/api/titiler-cmr/WebMercatorQuad/tilejson.json"
    name: (Raster Calculation Test) Net Biosphere Exchange (NBE) Rh+FIRE+FUEL-NPP
    description: Model-estimated net biosphere exchange (NBE), which is the net carbon flux to the atmosphere from the ecosystem, taking into account wildfire and wood fuel burning sources of carbon (Rh + FIRE + FUEL - NPP)
    time_density: Monthly
    initialDatetime: newest
    projection:
    ...
    sourceParams:
      ...
      variables: 
        ...
        - FUEL
        - Rh
      expression: 86400000*(Rh+FIRE+FUEL-NPP)
      colormap_name: coolwarm
      rescale:
        - -4
        - 4
    ...
    compare:
      datasetId: micasa-carbonflux-grid-cmr-v1
      layerId: micasa-co2-flux-nbe1-cmr-raster
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          if (dateFns && datetime && compareDatetime) return `${dateFns.format(datetime, 'LLL yyyy')} VS ${dateFns.format(compareDatetime, 'LLL yyyy')}`;
        }
  ...
  - id: micasa-co2-flux-nbe1-cmr-raster-diff-unit
    stacCol: micasa-carbonflux-daygrid-cmr-tes
    type: cmr
    stacApiEndpoint: "https://dev.ghg.center/api/stac/" 
    tileApiEndpoint: "https://staging.openveda.cloud/api/titiler-cmr/WebMercatorQuad/tilejson.json"
    name: (Raster Calculation Test) (Converted NPP data - Raw Data NPP)
    description: Model-estimated net biosphere exchange (NBE), which is the net carbon flux to the atmosphere from the ecosystem, taking into account wildfire and wood fuel burning sources of carbon (Rh + FIRE + FUEL - NPP)
    time_density: Monthly
    initialDatetime: newest
    projection:
    ...
    compare:
      datasetId: micasa-carbonflux-grid-cmr-v1
      layerId: micasa-co2-flux-nbe1-cmr-raster-diff-unit
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          if (dateFns && datetime && compareDatetime) return `${dateFns.format(datetime, 'LLL yyyy')} VS ${dateFns.format(compareDatetime, 'LLL yyyy')}`;
        }
  ...
  - id: micasa-co2-flux-nbe1-cmr-raster-diff
    stacCol: micasa-carbonflux-daygrid-cmr-tes
    type: cmr
    stacApiEndpoint: "https://dev.ghg.center/api/stac/" 
    tileApiEndpoint: "https://staging.openveda.cloud/api/titiler-cmr/WebMercatorQuad/tilejson.json"
    name: (Raster Calculation Test) (NEE+FIRE+FUEL)-(Rh+FIRE+FUEL-NPP)
    description: Model-estimated net biosphere exchange (NBE), which is the net carbon flux to the atmosphere from the ecosystem, taking into account wildfire and wood fuel burning sources of carbon (Rh + FIRE + FUEL - NPP)
    time_density: Monthly
    initialDatetime: newest
    projection:
    ...
    sourceParams:
      ...
      variables: 
        ...
        - FUEL
        - Rh
      expression: 86400000*(NEE+FIRE+FUEL)-86400000*(Rh+FIRE+FUEL-NPP)
      colormap_name: coolwarm
      rescale:
        - -4
        - 4
    ...
    compare:
      datasetId: micasa-carbonflux-grid-cmr-v1
      layerId: micasa-co2-flux-nbe1-cmr-raster-diff
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          if (dateFns && datetime && compareDatetime) return `${dateFns.format(datetime, 'LLL yyyy')} VS ${dateFns.format(compareDatetime, 'LLL yyyy')}`;
        }
