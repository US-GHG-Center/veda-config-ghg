...
<Block>
  <Prose>
    ...
    Brodrick, P.G., Thorpe, A.K., Fahlen, J., Thompson, D.R. (2025). EMIT Greenhouse Gas Algorithms:  Greenhouse Gas Point Source Mapping and Related Products, v2.0, November 2025, NASA Jet Propulsion Laboratory, California Institute of Technology, Pasadena, CA, [https://github.com/emit-sds/emit-sds-tgp/blob/main/docs/EMIT_L2B_TRACE_GAS_ATBD.md](https://github.com/emit-sds/emit-sds-tgp/blob/main/docs/EMIT_L2B_TRACE_GAS_ATBD.md)
