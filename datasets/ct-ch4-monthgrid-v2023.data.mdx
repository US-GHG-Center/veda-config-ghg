...
layers:
  - id: total-ch4
    stacCol: tm54dvar-ch4flux-monthgrid-v2
...
<Block>
  <Prose>
    ...
    - Expanded data availability from January 1998 - December 2023 (v1 data was only available for January 1999 - December 2016)
