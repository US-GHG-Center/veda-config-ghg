...
media:
  src: ::file ./media/ct-ch4-monthgrid-v2023-cover.webp
  alt: Landfill
  author:
...
layers:
  - id: total-ch4
    ...
    info:
      ...
      unit: g CH₄/m²/year                  
    media:
      src: ::file ./media/tm54dvar-ch4flux-monthgrid-v1.thumbnails.total.webp
  ...
  - id: microbial-ch4
    ...
    info:
      ...
      unit: g CH₄/m²/year               
    media:
      src: ::file ./media/tm54dvar-ch4flux-monthgrid-v1.thumbnails.microbial.webp
  ...
  - id: fossil-ch4
    ...
    info:
      ...
      unit: g CH₄/m²/year               
    media:
      src: ::file ./media/tm54dvar-ch4flux-monthgrid-v1.thumbnails.fossil.webp
  ...
  - id: pyrogenic-ch4
    ...
    info:
      ...
      unit: g CH₄/m²/year               
    media:
      src: ::file ./media/tm54dvar-ch4flux-monthgrid-v1.thumbnails.pyrogenic.webp
...
<Block>
  <Prose>
   ...
   v1 was updated to v2023 in the US GHG Center in December 2024. Updates included:
    ...
    ## Key Publications
    Oh, Y., Bruhwiler, L., Lan, X., Schuldt, K., Basu, S., Thoning, K., Michel, S. E., Clark, R., Miller, J. B., Andrews, A., Aalto, T., Andrade, M., Aoki, S., Apadula, F., Arduini, J., Arnold, S., … Zimnoch, M. (2025). CarbonTracker-CH4 Documentation CT-CH4 2025 release. [https://gml.noaa.gov/ccgg/carbontracker-ch4/documentation.php](https://gml.noaa.gov/ccgg/carbontracker-ch4/documentation.php)
