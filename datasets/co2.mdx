...
<Figure>
  ...
  alt='Atmospheric CO₂ differences in ppm'
  />
  <Caption 
  ...
  >
    ...
    **Bottom row**: observed changes in atmospheric CO₂ concentration differences derived from OCO-2 measurements. Blue shades indicate reductions in CO₂, while red shades indicate increases relative to the baseline CO₂ climatology.
  </Caption> 
</Figure>
</Block>
...
<Figure>
  ...
  alt='Bar chart of CO₂ concentration in Beijing for years 2017 through 2020'
  />
  <Caption 
    attrAuthor='ESA/JAXA' 
  >
  Monthly time series of lower atmospheric CO₂ enhancements over Beijing, China for January 2017 through April 2020 derived from GOSAT data. The results for January through April of prior years are shown in blue, while those for 2020 are shown in green.
  </Caption> 
</Figure>
<Prose>
