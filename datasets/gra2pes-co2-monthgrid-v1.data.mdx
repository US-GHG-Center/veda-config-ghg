...
<figure style={{ display: 'block' }}>
  <div className='dataset-comparison'>
    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
      <thead>
        <tr>
          <th style={{ borderBottom: '1px solid black' }}>Sector</th>
          <th style={{ borderBottom: '1px solid black' }}>ffCO₂ Data Source</th>
          <th style={{ borderBottom: '1px solid black' }}>Air Quality Data Source</th>
          <th style={{ borderBottom: '1px solid black' }}>Publications</th>
        </tr>
      </thead>
      <tbody>
        <tr>
        ...
        <tr>
          <td>Electricity Generating Unit (EGU)</td>
          <td>CEMS (CO₂)</td>
          <td>NEI17 + CEMS (NOₓ, SO₂ only)</td>
          <td>He et al., 2024</td>
        </tr>
        <tr>
          <td>Airport</td>
        ...
        <tr>
          <td>Oil and Gas</td>
          <td>GHGRP + FOG</td>
          <td>GHGRP + NEI17 + FOG</td>
          <td>Gorchov Negron et al., 2018, Francoeur et al., 2021</td>
        </tr>
        <tr>
          <td>On-road Gasoline</td>
          <td>FIVE</td>
          <td>FIVE</td>
          <td>McDonald et al., 2014, McDonald et al., 2018a, Harkins et al., 2021</td>
        </tr>
        <tr>
          <td>On-road Diesel</td>
          <td></td>
          <td></td>
          <td></td>
        </tr>
        ...
        <tr>
          <td>Volatile chemical products (VCP)</td>
          <td>N/A</td>
          <td>VCP</td>
          <td>McDonald et al., 2018b, Coggon et al., 2021, He et al., 2024</td>
        </tr>
        <tr>
          <td>Cooking</td>
          <td>N/A</td>
          <td>Observations + gridded population</td>
          <td>Coggon et al., 2024, Zhu et al., 2024 (under review)</td>
        </tr>
        <tr>
          <td>Shipping</td>
          <td>CAMSv4.2</td>
          <td>CAMSv4.2</td>
          <td>Granier et al., 2019</td>
        </tr>
        <tr>
          <td>International</td>
          <td>CAMSv4.2</td>
