...
usage:
  ...
  - url: 'https://www.datacommons.psu.edu/download/meteorology/influx/influx-tower-data/wmo-x2019-scale/'
    ...
    title: 'Data Browser'    
media:
  src: ::file ./media/nist-influx--dataset-cover.webp
...
infoDescription: |
  ::markdown
    - Temporal Extent: January 1, 2011 - May 2, 2025    
...
<Block type="wide">
  <Figure>
    <Embed
      height="800"
      src="https://earth.gov/ghgcenter/data-tools/view/nist-tower-data-viewer?agency=nist&region=in&zoom-level=8"
    />
  </Figure>
</Block>
<Block>
