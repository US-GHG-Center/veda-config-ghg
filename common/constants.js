import featureEmissions from "./media/refinery.webp";
import featureSources from "./media/swamp.webp";
import featureMethane from "./media/plume.webp";
...
export const dataEngagements = [
  ...
  },
  {
    ...
    "img": {
      "src": new URL('./media/interactive_map.webp', import.meta.url).href,
  ...
  },
  {
    ...
    "img": {
      "src": new URL('./media/jupyter_hub.webp', import.meta.url).href,
...
export const customInterfaces = [
  {
    ...
    "img": {
      "src": new URL('./media/GOES_Methane_Plume_viewer_card.webp', import.meta.url).href,
  ...
  },
  {
    ...
    "hideExternalLinkFlag": true,
    "img": {
      "src": new URL('./media/EMIT_Plume_Viewer_card.webp', import.meta.url).href,
  ...
  },
  {
    ...
    "img": {
      "src": new URL('./media/NOAA_Methane_Concentration_Viewer_card.webp', import.meta.url).href,
      ...
      "links": [
        {
          ...
          "url": "https://earth.gov/ghgcenter/data-tools/view/noaa-concentration-viewer?ghg=co2&frequency=all"
        },
        {
          "title": "Methane",
  ...
  },
  {
    ...
    "img": {
      "src": new URL('./media/NIST_NEC_Methane_Viewer_card1.webp', import.meta.url).href,
      ...
      "links": [
        {
          ...
          "url": "https://earth.gov/ghgcenter/data-tools/view/nist-tower-data-viewer?agency=nist&region=in&zoom-level=8"
        },
        {
          "title": "Los Angeles Megacity Carbon Project",
          "url": "https://earth.gov/ghgcenter/data-tools/view/nist-tower-data-viewer?agency=nist&region=lam&zoom-level=7"
        },
        {
          "title": "Northeast Corridor (NEC) Urban Test Bed",
          "url": "https://earth.gov/ghgcenter/data-tools/view/nist-tower-data-viewer?agency=nist&region=nec&zoom-level=5"
        }
      ]
    }
  },
...
export const cities = [
  {
    ...
    "img": {
      "src": new URL('../stories/media/baltimore_banner.webp', import.meta.url).href,
      "alt": "Baltimore"
    },
    "link": {
  ...
  },
  {
    ...
    "img": {
      "src": new URL('../stories/media/newyork_banner.webp', import.meta.url).href,
      "alt": "New York"
    },
    "link": {
      "url": "/stories/newyork",
  ...
  },
  {
    ...
    "img": {
      "src": new URL('../stories/media/sanfran_banner.webp', import.meta.url).href,
      "alt": "San Francisco"
    },
    "link": {
  ...
  },
  {
    ...
    "img": {
      "src": new URL('../stories/media/losangeles_banner.webp', import.meta.url).href,
      "alt": "Los Angeles"
    },
    "link": {
...
export const keyUrbanDatasets = [
  {
    ...
    "img": {
      "src": new URL('../stories/media/urban-1.webp', import.meta.url).href,
  ...
  },
  {
    ...
    "img": {
      "src": new URL('../stories/media/gra2pes.webp', import.meta.url).href,
  ...
  },
  {
    ...
    "img": {
      "src": new URL('../stories/media/US_INC_banner.webp', import.meta.url).href,
